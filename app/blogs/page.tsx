...
const blogs = [
  {
    ...
    description:
      "Explore how Equiview's multi-agent LLMs simulate hedge fund-style debates to evaluate market-moving news and earnings.",
  ...
  },
  {
    ...
    description:
      "See how Equiview's War Room handles real-time market scenarios to generate actionable financial insights.",
  ...
  },
  {
    ...
    description:
      "Understand how Equiview transforms financial news and reports into structured trade strategies using LLMs.",
  ...
  {
    title: "Earnings Report Breakdown: How Equiview Extracts Alpha",
    description:
      "Learn how Equiview parses quarterly earnings to uncover signals that inform hedge fund-level decisions.",
  ...
  {
    title: "Equiview vs Bloomberg Terminal: A New Age of Intelligence",
    description:
      "A head-to-head comparison of Equiview's LLM agents with traditional financial data terminals.",
    slug: "equiview-vs-bloomberg",
    category: "Comparison",
    readTime: "8 min read",
    date: "Mar 22, 2025",
  ...
  {
    title: "Behind the Scenes: How Equiview's LLM Agents Debate",
    description:
      ...
      <div className="relative bg-primary/5 border-b">
        <div className="container py-16">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-primary font-medium">Equiviewt Insights</h4>
          </div>
          ...
          <p className="text-muted-foreground max-w-2xl text-lg">
            ...
            strategy simulations, and how Equiview is revolutionizing
