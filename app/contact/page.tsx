      ...
      <div className="relative bg-primary/5 border-b">
        <div className="container py-16">
          ...
          <p className="text-muted-foreground max-w-2xl text-lg">
            Have questions about Equiview? We'd love to hear from you.
          </p>
        </div>
      </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contact@equiview.ai</p>
                    <p className="text-muted-foreground">support@equiview.ai</p>
                  </div>
                </div>
