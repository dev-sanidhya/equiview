            ...
            <Card className="border-primary/20 bg-primary/5 shadow-sm">
              <CardHeader>
                <CardTitle className="text-2xl">
                  Equiview: The Financial LLM War Room
                </CardTitle>
              ...
              <CardContent className="space-y-6 text-base">
                <p>
                  <strong>Equiview</strong> is a next-gen financial platform
                ...
                <p>
                  ...
                  pro, Equiview gives you an interactive space where AI agents
                ...
                <p>
                  Equiview isn't just analysis—it's a war room. Strategies
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="border-primary/10 shadow-sm">
              ...
              <CardContent className="text-muted-foreground">
                Equiview leverages cutting-edge multi-agent LLM systems,
